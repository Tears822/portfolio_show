    ...
    <header className="relative mx-auto mb-10 flex max-w-3xl flex-col items-center gap-y-6 px-4 text-center md:mb-14 md:gap-y-8 md:px-6">
      <div className="flex flex-col items-center gap-y-4 md:gap-y-5">
        ...
        <h2 className="font-geist text-3xl font-medium leading-tight text-white md:text-5xl md:leading-[1.15]">
          AI-first Fullstack Delivery, CMS Included When Needed
        </h2>
        <p className="max-w-2xl text-sm leading-relaxed text-white/85 md:text-base md:leading-7">
          Lead Software Engineer with 10+ years across product and platform engineering. I build fullstack systems with
          AI-driven workflows, automation, APIs, and cloud infrastructure. Shopify and WordPress remain additional skills
          for projects that also require commerce or editorial CMS capability.
        </p>
      </div>
      <a
      ...
      >
        <span className="relative z-10">Start a Fullstack AI Project</span>
      </a>
    </header>
  );
};
