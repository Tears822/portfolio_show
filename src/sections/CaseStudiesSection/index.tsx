...
export const CaseStudiesSection = () => {
  return (
    <section
      id="projects"
      className="relative overflow-hidden text-sm bg-no-repeat box-border caret-transparent leading-[24.5px] outline-[3px] scroll-mt-[47.875px] md:text-base md:leading-7 md:scroll-mt-[60px]"
    >
      <div
        aria-hidden="true"
